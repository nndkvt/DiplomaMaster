...
namespace DeltaRelationshipModelML.Model
{
    public class ConsumeModel
    {
        ...
        public static PredictionEngine<ModelInput, ModelOutput> CreatePredictionEngine()
        {
            ...
            //string modelPath = @"C:\Users\Oleg\AppData\Local\Temp\MLVSTools\DeltaRelationshipModelML\DeltaRelationshipModelML.Model\MLModel.zip";
            string modelPath = "Assets/Scripts/AI/DeltaRelationshipModelML.Model/MLModel.zip";
